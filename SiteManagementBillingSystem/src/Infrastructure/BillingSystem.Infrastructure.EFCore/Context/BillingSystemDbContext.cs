...
public class BillingSystemDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        new Apartment { Id = 1, Block = "A", Floor = 1, Number = 1, Type = "2+1", Resident = 1, Status = 1 },
        new Apartment { Id = 2, Block = "A", Floor = 1, Number = 2, Type = "2+1", Resident = 2, Status = 1 },
        new Apartment { Id = 3, Block = "A", Floor = 2, Number = 3, Type = "3+1", Resident = 1, Status = 0 },
        new Apartment { Id = 4, Block = "A", Floor = 2, Number = 4, Type = "3+1", Resident = 1, Status = 0 },
        new Apartment { Id = 5, Block = "A", Floor = 3, Number = 5, Type = "3+1", Resident = 1, Status = 0 },
        new Apartment { Id = 6, Block = "A", Floor = 3, Number = 6, Type = "3+1", Resident = 1, Status = 0 }
        );
        ...
        new Dues { Id = 1, Month = "July", Year = 2023, Amounth = 200, DuesPaymentStatus = 0, ApartmentId = 1 },
        new Dues { Id = 2, Month = "July", Year = 2023, Amounth = 200, DuesPaymentStatus = 0, ApartmentId = 2 },
        new Dues { Id = 3, Month = "July", Year = 2023, Amounth = 200, DuesPaymentStatus = 0, ApartmentId = 3}
        );
